...
<div class="sudokuoverlay">      
<button class="button" onclick="unpause()">Pause</button>
<button class="button" onclick="flyttogfyll()">Flytt over</button>
<button class="button" onclick="tom_brett()">Tøm brett</button>
</div>
